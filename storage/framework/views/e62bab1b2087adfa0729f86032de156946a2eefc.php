...
<script type="text/html" id="blueprintPage">
    ...
    <div>
        <div class="row">
            ...
            <div class="col-2">
            	<a class="nav-link" href="<?php echo e(url('api/blueprint/fullscreen')); ?>" target="_blank"><button class="btn btn-info btn-md" type = 'button'>Fullscreen</button></a>
            </div> 
            <div class="col-2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\johnn\Desktop\laravel\airlab\resources\views/index.blade.php ENDPATH**/ ?>